...
(function (root, factory) {
    ...
    var focusableElementSelector = 'a[href], areacode[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]';
