var bdAreaCtrl=function($scope,commonService,$uibModal){
    var app = this;
    $('#page-wrapper').removeClass('nav-small');
    var searchUrl="/rest/basic/area/grid.do";
    var removeUrl="/rest/basic/area/remove.do";
    $scope.searchItem={};
    $scope.data={};
    $scope.page=1;
    $scope.rows=10;
    ...
    $scope.modal=function (data,type,btnShow) {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'static/views/business/basic/area/areaModal.jsp',
            size: 'lg',
