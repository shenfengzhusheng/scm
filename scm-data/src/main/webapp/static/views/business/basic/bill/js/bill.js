var billCtrl=function($scope,$uibModal,commonService,$timeout){
    var app = this;
    $('#page-wrapper').removeClass('nav-small');
    var searchUrl="/rest/basic/bill/grid.do";
    var removeUrl="/rest/basic/bill/remove.do";
    $scope.searchItem={};
    $scope.data={};
    $scope.page=1;
    $scope.rows=10;
    ...
    $scope.modal=function (data,type,btnShow) {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'static/views/business/basic/bill/billModal.jsp',
            size: 'md',
