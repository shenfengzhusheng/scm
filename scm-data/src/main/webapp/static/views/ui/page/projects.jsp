    ...
    <div class="col-lg-4 col-md-6 col-sm-6" ng-controller="easyChartCtrl">
        <div class="main-box clearfix project-box emerald-box">
            <div class="main-box-body clearfix">
                ...
                <span class="chart" easypiechart percent="39" options="options">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6" ng-controller="easyChartCtrl">
        <div class="main-box clearfix project-box red-box">
            <div class="main-box-body clearfix">
                ...
                <div class="project-box-content">
<span class="chart" easypiechart percent="79" options="optionsRed">
<span class="percent"></span>%<br/>
<span class="lbl">completed</span>
</span>
                </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6" ng-controller="easyChartCtrl">
        <div class="main-box clearfix project-box yellow-box">
            <div class="main-box-body clearfix">
                ...
                <div class="project-box-content">
<span class="chart" easypiechart percent="47" options="optionsYellow">
<span class="percent"></span>%<br/>
<span class="lbl">completed</span>
</span>
                </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6" ng-controller="easyChartCtrl">
        <div class="main-box clearfix project-box purple-box">
            <div class="main-box-body clearfix">
                ...
                <div class="project-box-content">
<span class="chart" easypiechart percent="50" options="optionsPurple">
<span class="percent"></span>%<br/>
<span class="lbl">completed</span>
</span>
                </div>
                ...
                <div class="project-box-ultrafooter clearfix">
                    <img class="project-img-owner" alt="" src="static/core/img/simples/emma-300.jpg" data-toggle="tooltip" title="Emma Watson"/>
                    <img class="project-img-owner" alt="" src="static/core/img/simples/robert-300.jpg" data-toggle="tooltip" title="Robert Downey Jr."/>
                    <img class="project-img-owner" alt="" src="static/core/img/simples/kunis-300.jpg" data-toggle="tooltip" title="Mila Kunis"/>
                    <img class="project-img-owner" alt="" src="static/core/img/simples/angelina-300.jpg" data-toggle="tooltip" title="Angelina Jolie"/>
                    <a href="" class="link pull-right">
                        <i class="fa fa-arrow-circle-right fa-lg"></i>
                    </a>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6" ng-controller="easyChartCtrl">
        <div class="main-box clearfix project-box gray-box">
            <div class="main-box-body clearfix">
                ...
                <div class="project-box-content">
<span class="chart" easypiechart percent="91" options="optionsGray">
<span class="percent"></span>%<br/>
<span class="lbl">completed</span>
</span>
                </div>
