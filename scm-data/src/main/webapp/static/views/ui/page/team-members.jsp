...
<div class="row">
    <div class="col-lg-12">
        ...
        <h1>Team members <small>with Multiple color options</small></h1>
    </div>
</div>
<div class="row">
        ...
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/angelina-300.jpg" alt="" class="profile-img img-responsive" />
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/robert-300.jpg" alt="" class="profile-img img-responsive" />
                    <h2>Robert Downey</h2>
                    <div class="job-position">
                        Actor
                    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/kunis-300.jpg" alt="" class="profile-img img-responsive" />
                    <h2>Mila Kunis</h2>
                    <div class="job-position">
                        Actress
                    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/ryan-300.jpg" alt="" class="profile-img img-responsive" />
                    <h2>Ryan Gosling</h2>
                    <div class="job-position">
                        Actor
                    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/scarlett-300.jpg" alt="" class="profile-img img-responsive" />
                    <h2>S. Johansson</h2>
                    <div class="job-position">
                        Actress
                    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="main-box clearfix profile-box-contact">
            <div class="main-box-body clearfix">
                <div class="profile-box-header gray-bg clearfix">
                    <img src="${pageContext.request.contextPath}/static/core/img/simples/emma-300.jpg" alt="" class="profile-img img-responsive" />
                    <h2>Emma Watson</h2>
                    <div class="job-position">
                        Actress
                    </div>
