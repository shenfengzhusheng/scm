...
<link href="${pageContext.request.contextPath}/static/views/ui/form/wizard/bootstrap-wizard/bootstrap-wizard.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath}/static/views/ui/form/wizard/chosen/chosen.css" rel="stylesheet" />
<%--<script src="${pageContext.request.contextPath}/static/views/ui/form/wizard/js/jquery-2.0.3.min.js" type="text/javascript"></script>--%>
<script src="${pageContext.request.contextPath}/static/views/ui/form/wizard/chosen/chosen.jquery.js"></script>
<script src="${pageContext.request.contextPath}/static/views/ui/form/wizard/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/views/ui/form/wizard/js/prettify.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/views/ui/form/wizard/bootstrap-wizard/bootstrap-wizard.js" type="text/javascript"></script>
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li><a href="">Home</a></li>
        ...
        <div class="wizard" id="satellite-wizard" data-title="Create Server">
            ...
            <div class="wizard-card" data-cardname="group">
                ...
                <div class="wizard-input-section">
                    ...
                    <img class="wizard-group-list" src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/groups.png" />
                </div>
            </div>
            ...
            <div class="wizard-card wizard-card-overlay" data-onload="" data-cardname="location">
            ...
            <div class="wizard-card wizard-card-overlay">
                ...
                <div class="wizard-ns-detail hide">
                    ...
                    <ul id="wizard-ns-detail-servers">
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/folder.png" />Corporate sites</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/folder.png" />dt01.sat.medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />alisonline.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />circa-db04.sat.medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />circa-services01.sat.medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />circa-web01.sat.medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />heartbeat.alisonline.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />dt02.fre.medtelligent.com</li>
                        <li><img src="${pageContext.request.contextPath}/static/views/ui/form/wizard/img/server_new.png" />dev03.lin.medtelligent.com</li>
                    </ul>img				</div>
            </div>
