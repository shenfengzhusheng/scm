var payRecordCtrl=function($scope,$uibModal,commonService){
    var app = this;
    $('#page-wrapper').removeClass('nav-small');
    var searchUrl="/scm/pay/record/grid.do";
    var removeUrl="/scm/pay/record/remove.do";
    $scope.searchItem={};
    $scope.data={};
    $scope.page=1;
    $scope.rows=10;
    ...
    $scope.open=function(){
   //     $scope.data={version:'1.0',networkModel:'sm',deviceType:'auto'};
    ...
    $scope.modal=function (data,type,btnShow) {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'static/views/sys/pay/record/payRecordModal.jsp',
            size: 'lg',
           // ariaLabelledBy: 'modal-title',
           // ariaDescribedBy: 'modal-body',
            controller: 'payRecordModalCtrl',
            backdrop: 'static',
            keyboard: false,
            controllerAs: 'modal',
            resolve: {//传值
