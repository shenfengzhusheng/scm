...
//     onShowPanel : function() {
//         var _options = $(this).combotreegrid('options');
//         if (_options.mode == 'remote') {/* 如果是自动补全模式 */
//             var _value = $(this).combotreegrid('textbox').val();
//             if (_value.length > 0) {
//                 $(this).combotreegrid('grid').datagrid("load", {
//                     q : _value
//                 });
//             }
//         }
...
//         var _options = $(this).combotreegrid('options');
//         if (_options.mode == 'remote') {/* 如果是自动补全模式 */
//             var _data = $(this).combotreegrid('grid').datagrid('getData').rows;/* 下拉框所有选项 */
//             var _value = $(this).combotreegrid('getValue');/* 用户输入的值 */
//             var _b = false;/* 标识是否在下拉列表中找到了用户输入的字符 */
//             for (var i = 0; i < _data.length; i++) {
//                 if (_data[i][_options.idField] == _value) {
//                     _b = true;
