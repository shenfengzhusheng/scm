...
<head>
	 <title>Bootstrap实例</title>
  	...
  	<link rel="stylesheet" href="/src/main/webapp/resources/core/css/bootstrap.min.css">
  	  <!-- JavaScript 放置在文档最后面可以使页面加载速度更快 -->
    <!-- 可选: 包含 jQuery 库 -->
    <script src="/src/main/webapp/resources/core/js/jquery.min.js"></script>
    <!-- 可选: 合并了 Bootstrap JavaScript 插件 -->
    <script src="/src/main/webapp/resources/core/js/bootstrap.min.js"></script>
</head>
	<body>
	    <div class="container">
	      <h2>表格</h2>
