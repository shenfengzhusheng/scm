package org.xfs.scm.business.pay.ali.web;
...
import org.xfs.scm.business.pay.ali.model.AliAuthCode;
import org.xfs.scm.business.pay.ali.model.AliAuthTokenRequest;
...
public class AliPayWeb extends BaseWeb {
    ...
    public Object aliAuthToken(PayAccountVo vo){
        ...
        PayAccount data=this.payAccountService.getPayAccount(vo);
...
//                    if(this.payAccountService.modifyPayAccount(payAccountVo)==1){
