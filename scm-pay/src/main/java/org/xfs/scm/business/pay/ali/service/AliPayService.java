package org.xfs.scm.business.pay.ali.service;
...
import org.xfs.scm.business.pay.ali.model.AliPrecreateRequest;
import org.xfs.scm.business.pay.ali.model.TradeOrder;
...
public class AliPayService {
    ...
    public AlipayTradePrecreateResponse createPreperOrder(String appid,String temud){

        PayAccount data=this.getPayAccount(appid);
        if(data!=null){
...
//                   }).start();
    ...
    private void saveOrder(PayAccount data,TradeOrder order,String qrCode){
        ...
        this.payRecordService.addPayRecord(vo);
    }
    public BufferedImage generatorQrCode(String appid,String temid){
        AlipayTradePrecreateResponse response=this.createPreperOrder(appid,temid);
        if(response.isSuccess()){
    ...
    public PayAccount getPayAccount(String appid){
        if(StringUtil.isNotEmpty(appid)){
            return this.payAccountService.getPayAccount(new PayAccountVo(appid));
        }
        return null;
    }
    /**
