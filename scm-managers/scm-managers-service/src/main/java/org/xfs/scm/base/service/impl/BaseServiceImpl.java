package org.xfs.scm.base.service.impl;
...
public abstract class BaseServiceImpl<T extends BaseEntity> implements BaseServiceI<T>  {
    ...
    public int save(T t) {
        ...
        t.setLastUpdateTime(t.getCreatedTime());
