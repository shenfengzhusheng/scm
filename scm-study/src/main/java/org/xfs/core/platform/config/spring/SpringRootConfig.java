package org.xfs.core.platform.config.spring;
...
import org.xfs.core.platform.aop.AopConfig;
import org.xfs.core.platform.aop.CacheableAop;
...
@ComponentScan(basePackages = {"org.xfs.core.**.service"}/*
