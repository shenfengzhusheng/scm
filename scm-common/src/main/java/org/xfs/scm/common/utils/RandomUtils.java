...
public final class RandomUtils {
     ...
     * @return
     */
    public final static int getInteger(int scopeMin, int scoeMax) {
     ...
     * @return
     */
    public final static String getNumber(int length) {
     ...
     * @return 随机字符串
     */
    public final static String getMixString(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
     ...
     * @return 纯0字符串
     */
    public final static String getZeroString(int length) {
        StringBuffer sb = new StringBuffer();
        for (int i = 0; i < length; i++) {
            sb.append('0');
        }
     ...
     * 从指定的数组中随机数组中的某个元素
     */
    public final static Object getRandomItem(Object[] param) {
        int index = getInteger(0, param.length);
        return param[index];
    }
    ...
    public static void main(String[]args){
        System.out.println(getMixString(10));
    }
